! function(t) {
    ...
    if (document.getElementById('Array_mode').checked==false){ 
    if (ww>hh){ 
    ...
    if (document.getElementById('Array_mode').checked==true){ 
    if (ww>hh){ 
    add_corner_blob_array(XX+ww/2-hh/2,YY,hh,hh,1,0,'B',0);
    }else{
    add_corner_blob_array(XX,YY+hh/2-ww/2,ww,ww,1,0,'B',0);
    }}
